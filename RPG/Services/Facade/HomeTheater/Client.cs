using RPG.Services.Facade.HomeTheater.Facade;
using RPG.Services.Facade.HomeTheater.Subsystems;

namespace RPG.Services.Facade.HomeTheater;

public static class Client
{
    public static void OperatorHomeTheater()
    {
